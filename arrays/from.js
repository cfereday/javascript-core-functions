...
const executor = () => {
    console.log('Description: Array.from(): Makes a new array from sources you give it: i.e. a string of chars or . The Array.from() static method creates a new, shallow-copied Array instance from an array-like or iterable object.');
