...
const executor = () => {
    console.log('Description: Array.fill(): returns a modified array- changes all elements in an array to a static value, from a start index (default 0) to an end index (default array.length).');
